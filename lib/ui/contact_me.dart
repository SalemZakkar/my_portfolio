...
class _ContactMeState extends State<ContactMe> {
  List<String> title = ['Whatsapp', 'Email', 'Github', 'LinkedIn'];
  List<String> links = [
    "https://wa.me/+963949123587",
    'mailto://mr.salem1.sz@gmail.com',
    'https://github.com/salemzakkar',
    'https://linkedin.com/in/salemzakkar'
  ];
  List<Widget> icons = [
